export default {
  ...
  ADVANCED: "Advanced",
  ALREAD_HAVE_AN_ACCOUNT: "Already have an account",
  AND: "and",
  API_KEY: "API KEY",
  ARTICLE: "Article",
  ...
  BY_CLICKING_CONTINUE_YOU_AGREE: "By clicking continue you agree to",
  CANCEL: "Cancel",
  ...
  CONNECT_YOURSELF: "Connect yourself",
  ...
  PASSWORD: "Password",
  PORTAIL_CONNECTION: "Connexion portail",
  PREVIOUS: "Previous",
  ...
  TITLE_WEBSITE: "Replay Expert Music",
  TRY_AGAIN: "Try again",
  USER: "User",
  ...
  WELCOME_TO_YOUR_WORLD:
    "Welcome to our portal dedicated to experts in musical instrument repair. Find the best products and tools for your craft here. Join our community of passionate experts.",
